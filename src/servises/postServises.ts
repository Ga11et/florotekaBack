...
export const postServises = {
  postsMapping (posts: AirtablePostRecordType[]): PostPropsType[] {
    return posts.map(post => ({
      ...
      after: post.fields.after ? mainServises.imageMapping(post.fields.after)[0] : { small: '', full: '', id: '' },
      before: post.fields.before ? mainServises.imageMapping(post.fields.before)[0] : { small: '', full: '', id: '' },
      images: post.fields.images ? mainServises.imageMapping(post.fields.images) : [],
    }))
  }
}